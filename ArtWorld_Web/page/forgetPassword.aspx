...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	  ...
	  <div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="modalTokenNotFoundLabel">Link not found or expired</h5>
	...
	<div class="modal fade" id="modalResetPending" tabindex="-1" aria-labelledby="modalResetPendingLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="modalResetPendingLabel">Reset Password Link Sent</h5>
			<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		  </div>
		  <div class="modal-body">
			Please check your registered mailbox to get the reset password link.
		  </div>
		</div>
	  </div>
	</div>
	<button id="openModalResetPending" type="button" class="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#modalResetPending">
		open modal
	</button>
	<div class="modal fade" id="modalResetFailed" tabindex="-1" aria-labelledby="modalResetFailedLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="modalResetFailedLabel">Email not registered or incorrect</h5>
			<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		  </div>
		  <div class="modal-body">
			Please try again by entering registered email
		  </div>
		</div>
	  </div>
	</div>
	<button id="openModalResetFailed" type="button" class="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#modalResetFailed">
		open modal
	</button>
</asp:Content>
