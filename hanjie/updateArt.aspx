<%@ Page Title="" Language="C#" MasterPageFile="~/page/global.Master" AutoEventWireup="true" CodeBehind="updateArt.aspx.cs" Inherits="ArtWorld_Web.page.updateArt" %>
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                       <div class="col">
                           ...
                           <asp:DropDownList ID="ddlArtGallery" runat="server" CssClass="w-100" DataSourceID="SqlDataSourceGallery" DataTextField="name" DataValueField="galleryId" >
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                       <div class="col">
                           ...
                           <asp:DropDownList ID="ddlArtCategory" runat="server" CssClass="w-100" DataSourceID="SqlDataSourceCategory" DataTextField="name" DataValueField="categoryId" >
                               <asp:ListItem></asp:ListItem>
                           </asp:DropDownList>
                       </div>
                   </div>
                   ...
                   <div class="row">
                       <div class="col">
                           <asp:TextBox ID="txtStockNumber" runat="server" TextMode="Number" min="1">1</asp:TextBox>
                       </div>
                   </div>
                   ...
                   <div class="row">
                       <div class="col-2">
                           <asp:Button ID="btnUpdateArt" runat="server" Text="Update" OnClick="btnUpdateArt_Click"   />
                       </div>
                       <div class="col-2">
