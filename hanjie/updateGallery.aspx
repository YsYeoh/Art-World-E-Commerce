<%@ Page Title="" Language="C#" MasterPageFile="~/page/global.Master" AutoEventWireup="true" CodeBehind="updateGallery.aspx.cs" Inherits="ArtWorld_Web.page.updateGallery" %>
       ...
       <div class="row">
           <div class="col">
               <div class="card-body">
                   ...
                   <div class="row">
                       <div class="col-2">
                           <asp:Button ID="btnUpdateGallery" runat="server" Text="Update" OnClick="btnUpdateGallery_Click"  />
                       </div>
                       <div class="col-2">
                           <asp:Button ID="btnDeleteGallery" runat="server" Text="Delete" OnClick="btnDeleteGallery_Click"  />
                       </div>
                       <div class="col">
